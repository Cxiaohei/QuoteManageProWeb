...
export default {
  ...
  getters: {
    ...
    firstMenu(state, getters, rootState) {
      ...
      const {permissions, roles} = rootState.account
      return filterMenu(JSON.parse(JSON.stringify(arr)), permissions, roles)
    },
    subMenu(state, getters, rootState) {
      ...
      const {permissions, roles} = rootState.account
      return filterMenu(JSON.parse(JSON.stringify(current && current.children || [])), permissions, roles)
    }
  },
  mutations: {
