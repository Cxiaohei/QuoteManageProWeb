...
export async function setManufactureFee(params) {
    return request("/api/app/develop-project/develop-project-monitoring", METHOD.POST, params)
}

export async function editManufactureFee(params) {
    return request("/api/app/develop-project/develop-project-monitoring", METHOD.PUT, params)
}
