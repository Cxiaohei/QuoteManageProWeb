    ...
    <a-form-model-item label="项目目标" style="margin: 0;">
      <div style="display: flex; gap: 50px;">
        ...
        <ul style="padding: 0; flex: 1; list-style: none; margin: 0;">
          <li v-for="(item, index) in changeListData[0].projectObjectives" :key="`disabled-${index}`" style="margin-bottom: 8px;">
            <a-textarea
        ...
        <!-- 第二列 -->
        <ul style="padding: 0; flex: 1; list-style: none; margin: 0;">
          <li v-for="(item, index) in changeListData[1].projectObjectives" :key="`enabled-${index}`" style="margin-bottom: 8px;">
