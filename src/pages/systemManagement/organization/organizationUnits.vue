        ...
        <a-card :bordered="false">
          ...
          <!-- :expandedRowKeys="expandedRowKeys" -->
            ...
            <div slot="action" slot-scope="record">
              ...
              <a @click="addCustomer" style="margin-right: 5px;">添加成员</a>
              <a @click="addRoleList" style="margin-right: 5px;">添加角色</a>
              ...
              <!-- <template>
                <a-dropdown>
                  ...
                  <a-menu slot="overlay">
                    <a-menu-item>
                      <a @click="$refs.createModal.openModal(record)">编辑</a>
                    </a-menu-item>
                    <a-menu-item>
                      <a @click="$refs.create.openModal(record)">添加子机构</a>
                    </a-menu-item>
                    <a-menu-item>
                      <a @click="addCustomer">添加成员</a>
                    </a-menu-item>
                    <a-menu-item>
                      <a @click="addRoleList">添加角色</a>
                    </a-menu-item>
                    <a-menu-item>
                      <a-popconfirm title="确定要删除吗？" @confirm="handleDel(record.id)">
                        <a href="javascript:;">删除</a>
          ...
          <a-tabs default-active-key="1" @change="callback">
            <a-tab-pane key="1" tab="成员">
              ...
              <div v-if="!isChecked">
                ...
                >
                  <div slot="action" slot-scope="{ record }">
                    <a-popconfirm title="确定要删除吗？" @confirm="handleDelMember(record.id)">
                      <a href="javascript:;">删除</a>
                    </a-popconfirm>
                    <!-- <template>
                      <a-dropdown>
...
import {
  ...
  getRole,
  delRole
} from "@/services/organization/tenant";
const datas = [
  {
    code: "00001",
