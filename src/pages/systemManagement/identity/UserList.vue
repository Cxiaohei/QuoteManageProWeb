    ...
    <div :class="advanced ? 'search' : null">
      <a-form layout="horizontal">
        <div :class="advanced ? null : 'fold'">
          <a-row>
            <a-col :md="8" :sm="24">
              <a-form-item label="搜索" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
            ...
            <a-col :md="8" :sm="24">
              <a-form-item label="角色" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                <a-select v-model="queryParam.roleId" allowClear @change="handleChange">
    ...
    <div>
      ...
      >
        ...
        <div slot="action" slot-scope="{ record }">
          <template>
            <a href="javascript:;" @click="$refs.createModal.openModal(record)" v-if="checkPermission('AbpIdentity.Users.Update')" style="margin-right: 5px;">编辑</a>
            <a href="javascript:;" @click="$refs.permissionModal.openModal(record)" v-if="checkPermission('AbpIdentity.Users.ManagePermissions')" style="margin-right: 5px;">权限</a>
            <a-popconfirm title="确定要删除吗？" v-if="checkPermission('AbpIdentity.Users.Delete')" @confirm="handleDel(record.id)">
